...
<CodeBlock lang="html" filename="index.html">
```html
...
<CodeBlock lang="css" filename="styles.css">
```css
.code-container {
  display: grid;
...
<CodeBlock lang="typescript" filename="script.ts">
```ts
...
<CodeBlock lang="typescript" filename="code-input.ts">
```ts
