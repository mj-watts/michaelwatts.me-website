...
export const exampleCss = {
  ...
  header:
    "text-base font-bold uppercase bg-amber-500 text-brand-950 p-8 rounded mt-0 mb-1",
  card: "border border-slate-200 border-0 bg-brand-950 rounded overflow-hidden shadow-xl flex flex-col",
  innerUl:
    "mt-0 mb- 0 w-full list-none bg-brand-900 rounded font-mono p-0 text-black flex flex-col gap-1",
...
<CodeBlock filename="example.html">
...
<ul class={exampleCss.ul}>
  <li class={exampleCss.li}>
    ...
    <div class={exampleCss.card}>
      ...
      <div class="flex justify-between items-baseline p-8">
        <p class="mb-0 mt-0">
          <a href="https://example.com" class="leading-3 text-base font-bold">
            War a real threat and Europe not ready, warns Poland's PM
          </a>
        </p>
  ...
  <li class={exampleCss.li}>
    ...
    <ul class={exampleCss.innerUl}>
      ...
      <li class={exampleCss.innerLi}>
        💬 Image alt: "A man stands on the edge of a cliff looking out to a
        rough sea"
      </li>
      <li class={exampleCss.innerLi}>
        💬 Heading tag H6 0. Link "War a real threat and Europe not ready, warns
        Poland's PM" to "https://example.com"
      </li>
...
<ul class={exampleCss.ul}>
    ...
    <div class={exampleCss.card}>
      <p class="order-2 flex justify-between items-baseline p-8 mt-0 mb-0">
        <a
          ...
          class="text-lg leading-relaxed font-bold after::content-[''] after:absolute after:top-0 after:left-0 after:right-0 after:bottom-0 after:z-99"
        >
          War a real threat and Europe not ready, warns Poland's PM
        </a>
        <time class="text-sm">01/02/24</time>
  ...
  <li class={exampleCss.li}>
    ...
    <ul class={exampleCss.innerUl}>
      ...
      <li class={exampleCss.innerLi + exampleCss.innerLiLineThrough}>
