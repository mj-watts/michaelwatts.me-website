...
<ul class="list-none bg-stripes-slate rounded-lg m-0 p-1 flex flex-col xl:flex-row gap-1">
  <li class="list-none xl:w-80 bg-slate-100 dark:bg-slate-800 rounded overflow-hidden shadow-2xl border m-0 p-0">
    <a href="https://example.com">
      <img
        src="/posts/manonbeach.jpg"
        alt="A man stands on the edge of a cliff looking out to a rough sea."
  ...
  <li class="list-none w-auto m-0 border p-1 rounded">
    <h2 class="m-0 text-base uppercase mb-1 bg-white p-3 rounded">🤖 Screen reader output:</h2>
    <ul class="list-none bg-stripes-amber rounded-lg font-mono p-1 m-0 text-black">
      <li class="p-3 font-bold bg-amber-500 mb-1 rounded-lg list-none m-0">💬 link image to https://example.com</li>
      <li class="p-3 font-bold bg-amber-500 mb-1 rounded-lg list-none m-0">💬 Image alt: "A man stands on the edge of a cliff looking out to a rough sea"</li>
      <li class="p-3 font-bold bg-amber-500 mb-1 rounded-lg list-none m-0">💬 Heading tag H6 0. Link "War a real threat and Europe not ready, warns Poland's PM" to "https://example.com"</li>
      <li class="p-3 font-bold bg-amber-500 rounded-lg list-none m-0">💬 01/02/24</li>
    </ul>
  </li>
</ul>
...
<ul class="list-none bg-stripes-slate rounded-lg m-0 p-1 flex flex-col xl:flex-row gap-1">
  <li class="flex flex-col list-none xl:w-80 bg-slate-100 dark:bg-slate-800 rounded overflow-hidden shadow-2xl border relative m-0 p-0">
  ...
  <li class="list-none w-auto m-0 border p-1 rounded">
    <h2 class="m-0 text-base uppercase mb-1 bg-white p-3 rounded">🤖 Screen reader output:</h2>
    <ul class="list-none bg-stripes-amber rounded-lg font-mono p-1 m-0 text-black">
      <li class="p-3 font-bold bg-amber-500 mb-1 rounded-lg list-none m-0">💬 "War a real threat and Europe not ready, warns Poland's PM"</li>
      <li class="p-3 font-bold bg-stripes-amber opacity-50 mb-1 rounded-lg list-none line-through m-0">💬 Image alt: "A man stands on the edge of a cliff..."</li>
      <li class="p-3 font-bold bg-stripes-amber opacity-30 mb-1 rounded-lg list-none line-through m-0">💬 Heading tag H6 0. Link "War a real threat and Europe not...</li>
      <li class="p-3 font-bold bg-stripes-amber opacity-15 rounded-lg list-none line-through m-0">💬 01/02/24</li>
    </ul>
  </li>
</ul>
