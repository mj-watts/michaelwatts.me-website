...
<LeadParagraph>
  I've implemented the Shiki diff notation transformer plugin, which provides a brilliant way to highlight code changes in your documentation or blog posts.
</LeadParagraph>
...
<CodeBlock lang="ts" filename="example.ts">
```ts
...
<CodeBlock lang="tsx" filename="Welcome.tsx">
```tsx
function Welcome() {
    return (
