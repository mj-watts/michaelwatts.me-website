...
<div>
  At Streeva, I enhanced the Gift Aid platform Swiftaid—used by thousands of
  charities and platforms including JustGiving, Shelter and Comic Relief—by
  moving the codebase to TypeScript, aligning Vue apps with C# services, and
  introducing BDD to boost reliability.
</div>
<div>
  With millions of donors on the platform scalability was important to get
  right. I also built a secure admin portal using Vue and C# to streamline
