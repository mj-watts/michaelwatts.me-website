...
## Secure and accessible administrative portal built for HMRC

<div>
  I was part of team that designed, developed and delivered an HMRC
  proof-of-concept application that securely handled large-scale transactional
  data, using Elasticsearch and Kibana for advanced search and visualisation.
</div>
